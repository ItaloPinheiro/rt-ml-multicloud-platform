...
from src.feature_engineering.beam.pipelines import FeatureEngineeringPipeline, create_aws_pipeline_config

def main():
    parser = argparse.ArgumentParser(description="Run AWS Kinesis to S3 Beam Pipeline for Feature Engineering")
    parser.add_argument("--stream-name", type=str, required=True, help="Kinesis Data Stream name")
    parser.add_argument("--s3-bucket", type=str, required=True, help="S3 bucket for storing processed features")
